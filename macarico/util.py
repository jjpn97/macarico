    ...
    def train(self,
        ...
        for self.epoch in range(low_epoch, self.n_epochs+1):
            ...
            for batch_id, (batch, is_last_batch) in enumerate(minibatches):
                ...
                if self.policies:
                    [x.new_minibatch() for x in self.policies]
                else:
                ...
                for env in batch:
                    ...
                    if self.policies:
                        [x.new_example() for x in self.policies]
                    else:
                    ...
                    self.objective_average.update(obj if isinstance(obj, float) else obj.data.item())
                    total_obj += obj
